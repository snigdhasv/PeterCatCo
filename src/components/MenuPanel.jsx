...
export const MenuPanel = () => {
  ...
  return (
    <>
      <div id="wrapper">
          <header>
            <div className="iconDiv" tooltip="Animate" tabIndex="0">
            ...
            <div className="iconDiv" tooltip="Textures & Materials" tabIndex="0" onClick={()=>setTexturesMaterials(!TexturesMaterials)}>
              <div className="iconSVG">
